...
export function Vector9Icon(props: Vector9IconProps) {
  ...
  return (
    ...
    >
      ...
      <path
        d={
          "M18.4 10.894a1.33 1.33 0 001.333-1.328c0-.734-.597-1.329-1.333-1.329a1.33 1.33 0 00-1.333 1.329 1.33 1.33 0 001.333 1.328zm2.933 2.923a1.336 1.336 0 01-1.232-.82 1.325 1.325 0 01.29-1.449 1.335 1.335 0 012.276.944 1.335 1.335 0 01-1.333 1.325zm0-5.845c.737 0 1.334-.595 1.334-1.329s-.597-1.329-1.334-1.329c-.736 0-1.333.595-1.333 1.329s.597 1.329 1.333 1.329zm2.934 2.922A1.33 1.33 0 0025.6 9.566a1.33 1.33 0 00-1.333-1.329c-.737 0-1.334.595-1.334 1.329s.597 1.328 1.334 1.328z"
        }
        fill={"currentColor"}
      ></path>
